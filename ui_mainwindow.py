...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalWidget.setGeometry(QRect(0, 0, 381, 1031))
        self.verticalWidget.setStyleSheet(u"border-right: 2px solid black;")
        self.patientDetails = QGroupBox(self.verticalWidget)
        self.patientDetails.setObjectName(u"patientDetails")
        self.patientDetails.setGeometry(QRect(10, 350, 361, 621))
        ...
        self.searchInput.setGeometry(QRect(10, 50, 261, 31))
        self.searchPatient = QPushButton(self.verticalWidget)
        self.searchPatient.setObjectName(u"searchPatient")
        self.searchPatient.setGeometry(QRect(280, 50, 89, 31))
        self.searchLabel = QLabel(self.verticalWidget)
        self.searchLabel.setObjectName(u"searchLabel")
        self.searchLabel.setGeometry(QRect(10, 20, 251, 21))
        self.stackedWidget = QStackedWidget(self.centralwidget)
        self.stackedWidget.setObjectName(u"stackedWidget")
        self.stackedWidget.setGeometry(QRect(390, 10, 1511, 1021))
        ...
        self.label_3.setGeometry(QRect(560, 30, 111, 31))
        ...
        self.label_4.setGeometry(QRect(560, 30, 111, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.textDetails.setText(QCoreApplication.translate("MainWindow", u"Name:", None))
        ...
        self.searchPatient.setText(QCoreApplication.translate("MainWindow", u"Search", None))
